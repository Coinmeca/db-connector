...
import (
	"coinmeca-batch/conf"
	"coinmeca-batch/key"
	"coinmeca-batch/model/modelbatch"
	"coinmeca-batch/model/modelcontract"
	"coinmeca-batch/model/modelfarm"
	"coinmeca-batch/model/modelmarket"
	"coinmeca-batch/model/modeltreasury"
	"coinmeca-batch/model/modelvault"
	"fmt"
	"reflect"
	"sync"
